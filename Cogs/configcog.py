...
class ConfigCog(commands.Cog):
    ...
    async def send_role_prompt(self, ctx, role_type, admin_roles, moderator_roles, helper_roles):
        ...
        e.set_author(name="Staff Roles", icon_url=quake_logo)
    ...
    async def log(self, ctx):
        ...
        try:
            ...
            e = discord.Embed(color=quake_color)
            e.set_author(name="📋 Logging", icon_url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
    ...
    async def suggest(self, ctx):
        ...
        try:
            ...
            e = discord.Embed(color=quake_color)
            e.set_author(name="💡 Suggestions", icon_url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            e.set_thumbnail(url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
    ...
    async def star(self, ctx):
        ...
        try:
            ...
            e = discord.Embed(color=quake_color)
            e.set_author(name="⭐️ Starboard", icon_url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            e.set_thumbnail(url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
    ...
    async def welcome(self, ctx):
        ...
        try:
            ...
            e = discord.Embed(color=quake_color)
            e.set_author(name="👋 Welcome Messages", icon_url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            e.set_thumbnail(url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
    ...
    async def leave(self, ctx):
        ...
        try:
            ...
            e = discord.Embed(color=quake_color)
            e.set_author(name="🚫 Leave Messages", icon_url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            e.set_thumbnail(url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
    ...
    async def boost(self, ctx):
        ...
        try:
            ...
            e = discord.Embed(color=quake_color)
            e.set_author(name="Boost Messages", icon_url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            e.set_thumbnail(url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
    ...
    async def autorole(self, ctx):
        ...
        try:
            ...
            e = discord.Embed(color=quake_color)
            e.set_author(name="🤖 Autorole", icon_url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            e.set_thumbnail(url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
    ...
    async def filter(self, ctx):
        ...
        try:
            ...
            e = discord.Embed(color=quake_color)
            e.set_author(name="🔇 Chat Filter", icon_url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            e.set_thumbnail(url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
    ...
    async def staff(self, ctx):
        ...
        try:
            e = discord.Embed(color=quake_color)
            e.set_author(name="Staff Roles", icon_url = ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            e.set_thumbnail(url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
    ...
    async def welcome(self, ctx):
        ...
        try:
            e = discord.Embed(color=quake_color)
            e.set_author(name="Welcome Message Setup", icon_url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            e.set_thumbnail(url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            ...
            while True:
                ...
                confirm_embed = discord.Embed(color=quake_color)
                confirm_embed.set_author(name=f"{ctx.guild.name}'s Welcome Message", icon_url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
                confirm_embed.set_thumbnail(url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
    ...
    async def leave(self, ctx):
        ...
        try:
            e = discord.Embed(color=quake_color)
            e.set_author(name="Leave Message Setup", icon_url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            e.set_thumbnail(url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            ...
            while True:
                ...
                confirm_embed = discord.Embed(color=quake_color)
                confirm_embed.set_author(name=f"{ctx.guild.name}'s Leave Message", icon_url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
                confirm_embed.set_thumbnail(url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
                confirm_embed.description = (f"*Does this look correct? If not, click* ***No*** *and remake it!*\n\n"
                                             f"{preview_message}")
                view = discord.ui.View()
    ...
    async def boost(self, ctx):
        ...
        try:
            e = discord.Embed(color=quake_color)
            e.set_author(name="Boost Message Setup", icon_url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            e.set_thumbnail(url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            ...
            preview_embed.title = f"<a:Boost:1363355197832826950> {ctx.author.name} boosted the server!"
    ...
    def format_embed(self, ctx, admin_roles, moderator_roles, helper_roles):
        embed = discord.Embed(color=quake_color)
        embed.set_author(name=f"{ctx.guild.name} Staff Roles", icon_url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
        embed.set_thumbnail(url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
    ...
    async def boost(self, ctx):
        ...
        try:
            ...
            if config and config.get('toggle_boost') and config.get('boost_channel'):
                ...
                embed.title = f"<a:Boost:1363355197832826950> {ctx.author.name} boosted the server!"
    ...
    async def show(self, ctx):
        ...
        try:
            ...
            if not config or not config.get('toggle_filter'):
                ...
                return
            e = discord.Embed(color=quake_color)
            e.set_author(name=f"{ctx.guild.name} Chat Filter Settings", icon_url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            e.set_thumbnail(url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            filtered_words = config.get('filtered_words', '').split(',')
    ...
    async def help(self, ctx):
        if not ctx.author.guild_permissions.administrator and not await self.has_admin_role(ctx.author, ctx.guild.id):
            ...
            return
        try:
            e = discord.Embed(title=f"⚙️ Filter Help ⚙️", color=quake_color)
            e.description = f"Here are the available public commands for managing the Filter. \n\n### 📌 Filter Commands 📌 \n> 💡 `/toggle filter` **|** Toggles the chat filter feature \n> ⚙️ `/filter help` **|** Sends the Filter Help Menu \n> 📑 `/filter defaults` **|** Adds a default list of slurs to **{ctx.guild.name}'s** filter \n> ➕ `/filter add [word]` **|** Adds a word to the filter \n> ➖ `/filter remove [word]` **|** Removes a word from the filter \n> ♻️ `/filter clear` **|** Clears the filter \n> 🔕 `/filter ignore [word]` **|** Ignores a word that contains a word in the filter **Ex:** If you ignore '**hi**', the message won't be deleted when someone says '**hit**'. \n> 🔔 `/filter unignore [word]` **|** Unignores a word that contains a word in the filter \n> ❌ `/filter block [user] [role] [channel] [category_id]` **|** When a user, role, channel or category is 'blocked' their message won't get deleted when they say a word in the filter \n> ✅ `/filter unblock [user] [role] [channel] [category_id]` **|** Unblocks a user, role, channel or category you had blocked\n> 📰 `/filter show` **|** Shows all the information about the chat filter"
            await ctx.send(embed=e, ephemeral=True)
        except Exception as e:
            print(e)
    ...
    async def configs(self, ctx):
        ...
        try:
            ...
            if not config:
                ...
                return
            e = discord.Embed(color=quake_color)
            e.set_author(name=f"{ctx.guild.name} Configurations", icon_url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            e.set_thumbnail(url=ctx.guild.icon.url if ctx.guild.icon else quake_logo)
            ...
            add_toggle_field("<a:Boost:1363355197832826950> Boost Messages", 'toggle_boost', 'boost_channel')
