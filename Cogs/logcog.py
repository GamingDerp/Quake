...
class LogCog(commands.Cog):
    ...
    async def on_message_delete(self, message):
        try:
            ...
            e.description = f"A message by a {user_type}, {message.author.mention}, was deleted \n<:ChainReply:1363355175032459544> In <#{message.channel.id}> \n<:Reply:1363355152244805682> **Message ID:** {message.id}"
            if message.content:
    ...
    async def on_message_edit(self, before, after):
        try:
            ...
            e.description = f"A {user_type}, {before.author.mention}, edited their message \n<:ChainReply:1363355175032459544> In <#{before.channel.id}> \n<:ChainReply:1363355175032459544>**User ID:** {before.author.id} \n<:ChainReply:1363355175032459544> **Message ID:** {before.id} \n<:Reply:1363355152244805682> [**Jump to Message**]({after.jump_url})"
    ...
    async def on_member_join(self, member):
        ...
        e.description = f"A {user_type}, {member.name} ({member.mention}) joined **{member.guild.name}** \n<:ChainReply:1363355175032459544> **User ID:** {member.id} \n<:Reply:1363355152244805682> **Created:** <t:{creation_timestamp}:f>"
        e.timestamp = datetime.utcnow()
    ...
    async def on_member_remove(self, member):
        ...
        e.description = f"A {user_type}, {member.name} ({member.mention}) left **{member.guild.name}** \n<:ChainReply:1363355175032459544> **User ID:** {member.id} \n<:ChainReply:1363355175032459544> **Created:** <t:{creation_timestamp}:f> \n<:Reply:1363355152244805682> **Joined:** <t:{join_timestamp}:f>"
        e.timestamp = datetime.utcnow()
        await self.log_event(member.guild, e)
    ...
    async def on_member_ban(self, guild, member):
        ...
        if logging_channel:
            ...
            creation_timestamp = int(member.created_at.timestamp())
            join_timestamp = int(member.joined_at.timestamp())
            e.description = f"A {user_type}, {member.name} ({member.mention}) was banned from **{guild.name}** \n<:ChainReply:1363355175032459544> **User ID:** {member.id} \n<:ChainReply:1363355175032459544> **Created:** <t:{creation_timestamp}:f> \n<:ChainReply:1363355175032459544> **Joined:** <t:{join_timestamp}:f> \n<:ChainReply:1363355175032459544> **Ban Reason:** {logs.reason } \n<:ChainReply:1363355175032459544> **Staff:** {logs.user.mention} \n<:Reply:1363355152244805682> **Staff ID:** {logs.user.id}"
            e.timestamp = datetime.utcnow()
    ...
    async def on_member_update(self, before, after):
        ...
        if len(before.roles) > len(after.roles):
            ...
            e.description = f"A {user_type}, {before.name} ({before.mention}) had a role removed \n<:ChainReply:1363355175032459544> **User ID:** {before.id} \n<:Reply:1363355152244805682> **Role:** {droles.mention} ({droles.id})"
