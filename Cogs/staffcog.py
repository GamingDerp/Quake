...
class StaffCog(commands.Cog):
    ...
    async def ban(self, ctx, member: discord.Member, *, reason=None):
        ...
        try:
            ...
            e.title = "<:BanHammer:1363355199216816290> Banned <:BanHammer:1363355199216816290>"
    ...
    async def mute(self, ctx, member: discord.Member, duration, *, reason=None):
        ...
        try:
            ...
            e = discord.Embed(color=quake_color)
            e.title = "🔐 Mute 🔐"
            e.description = f"{member.mention} has been muted! \n\n📝 **Reason:** {reason} \n⏳ **Duration:** {duration}"
            await ctx.send(embed=e)
            await self.log_action(ctx, "🔐 User Muted 🔐", member, reason, duration)
    ...
    async def unmute(self, ctx, member: discord.Member, *, reason=None):
        ...
        try:
            ...
            e = discord.Embed(color=mmute_color)
            e.title = "🔓 Ungulag 🔓"
    ...
    async def warn(self, ctx, member: discord.Member, *, reason=None):
        ...
        try:
            if await self.add_warn(ctx.guild.id, member.id, reason):
                e = discord.Embed(color=mute_color)
                e.title = "⚠️ Warn ⚠️"
