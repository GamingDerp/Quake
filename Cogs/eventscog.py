...
class EventsCog(commands.Cog):
    ...
    async def on_ready(self):
        await self.bot.change_presence(activity=discord.Game(name="Helping Quake Users..."))
    ...
    async def on_guild_join(self, guild):
        try:
            ...
            e.timestamp = datetime.utcnow()
            await channel.send(embed=e)
            setup_embed = discord.Embed(color=quake_color)
            setup_embed.set_author(name="Thank you for adding Quake!", icon_url=quake_logo)
            setup_embed.set_thumbnail(url=quake_logo)
